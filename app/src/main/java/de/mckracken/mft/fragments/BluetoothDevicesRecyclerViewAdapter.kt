...
class BluetoothDeviceRecyclerViewAdapter(val context: Context, var devicesArray: ArrayList<BluetoothDevice>, val bluetoothManager: CustomBluetoothManager)  : RecyclerView.Adapter<BluetoothDeviceRecyclerViewAdapter.DeviceViewHolder>() {
